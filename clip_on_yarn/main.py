...
def training_loop(
    ...
    if rank == 0 and enable_wandb:
        os.environ["WANDB_API_KEY"] = "6a9bec2b43987680ed38f09475e0f787f69487fb" # Replace by your API key
        os.environ["WANDB_ENTITY"] = "guillaume-lagarde" # Replace by your entity name
